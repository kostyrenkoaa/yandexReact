...
import {IngredientT, useAppSelector} from '../../utils/types';
...
export default function OrdersFeedItem({
  ...
  let orderIngredients: IngredientT[] = [];
  ingredientList.forEach(currentItem => {
    let currentIngredient = ingredients.find((item: IngredientT) => item._id === currentItem);
